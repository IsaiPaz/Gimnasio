 ...
 * Se añade la nueva opción al menú del administrador.
 */
"use client";
...
// ... (El código de los iconos y la interfaz UserSession permanece igual)
...
export default function DashboardPage() {
  ...
  if (!session) return <main className="flex min-h-screen items-center justify-center"><p>Cargando...</p></main>;
    ...
    <main className="min-h-screen bg-gray-100">
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <button onClick={handleLogout} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded transition-colors">Cerrar Sesión</button>
        </div>
      </header>
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {session.rol === 'miembro' && ( /* Opciones para Miembros */ <>
            ...
            {session.rol === 'recepcionista' && ( /* Opciones para Recepcionistas */ <>
            ...
            {session.rol === 'administrador' && ( /* Opciones para Administradores */ <>
